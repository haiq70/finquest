...
const styles = StyleSheet.create({
  ...
  sectionHeader:{ fontSize: 12, fontWeight: FontWeight.semibold, color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 8, marginTop: Spacing.md },
